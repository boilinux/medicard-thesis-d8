var Calendar = function() {
    ...
    return {
        ...
        initCalendar: function() {
            ...
            if (Metronic.isRTL()) {
                if (jQuery('#calendar').parents(".portlet").width() <= 720) {
            ...
            var addEvent = function(title) {
                ...
                var html = jQuery('<div class="external-event label label-default">' + title + '</div>');
            ...
            jQuery('#event_add').unbind('click').click(function() {
