...
var QuickSidebar = function () {
    ...
    var handleQuickSidebarToggler = function () {
        ...
        jQuery('.top-menu .dropdown-quick-sidebar-toggler a, .page-quick-sidebar-toggler').click(function (e) {
            jQuery('body').toggleClass('page-quick-sidebar-open'); 
        });
    };

    // Handles quick sidebar chats
    var handleQuickSidebarChat = function () {
        var wrapper = jQuery('.page-quick-sidebar-wrapper');
