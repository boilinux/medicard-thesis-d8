    ...
    if (apiHelper::check_user_role('nurse')) {
      ...
      foreach ($data['patient'] as $nid => $patient) {
        ...
        if (!empty($patient['findings'])) {
          ...
          $accordion .= "<div id='findings" . $nid . "' class='portlet-body hide2 hide' style='display:none;'>";
        ...
        if (!empty($patient['recommendation'])) {
          ...
          $accordion .= "<div id='recommendation" . $nid . "' class='portlet-body hide2 hide' style='display:none;'>";
        ...
        if (!empty($patient['result'])) {
          ...
          $accordion .= "<div id='result" . $nid . "' class='portlet-body hide2 hide' style='display:none;'>";
        ...
        //   $accordion .= "<div id='prescription" . $nid . "' class='portlet-body hide2 hide' style='display:none;'>";
        ...
        if (!empty($patient['pharmacomment'])) {
          ...
          $accordion .= "<div id='pharmacomment" . $nid . "' class='portlet-body hide2 hide' style='display:none;'>";
      ...
      foreach ($data['patient'] as $nid => $patient) {
        ...
        if (!empty($patient['revision'])) {
          ...
          $accordion .= "<div id='revision" . $nid . "' class='portlet-body hide2 hide' style='display:none;'>";
