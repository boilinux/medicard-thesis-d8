    ...
    if (apiHelper::check_user_role('nurse')) {
      ...
      foreach ($data['patient'] as $nid => $patient) {
        ...
        if (!empty($patient['findings'])) {
          ...
          $accordion .= "<div id='findings" . $nid . "' class='portlet-body hide2' style='display:none;'>";
        ...
        if (!empty($patient['recommendation'])) {
          ...
          $accordion .= "<div id='recommendation" . $nid . "' class='portlet-body hide2' style='display:none;'>";
        ...
        if (!empty($patient['result'])) {
          ...
          $accordion .= "<div id='result" . $nid . "' class='portlet-body hide2' style='display:none;'>";
        ...
        if (!empty($patient['prescription'])) {
          ...
          $accordion .= "<div id='prescription" . $nid . "' class='portlet-body hide2' style='display:none;'>";
        ...
        if (!empty($patient['pharmacomment'])) {
          ...
          $accordion .= "<div id='pharmacomment" . $nid . "' class='portlet-body hide2' style='display:none;'>";
        ...
        foreach ($data['patient'] as $nid => $patient) {
          if ($patient['card_id'] == $card) {
            ...
            if (!empty($patient['pharmacomment'])) {
              ...
              $accordion .= "<div id='pharmacomment' class='portlet-body hide2' style='display:none;'>";
              foreach ($patient['pharmacomment'] as $val) {
                $accordion .= "<p>" . $val['value'] . "</p>";
              }
              $accordion .= "</div></div>";
      ...
      foreach ($data['patient'] as $nid => $patient) {
        ...
        if (!empty($patient['revision'])) {
          ...
          $accordion .= "<div id='revision" . $nid . "' class='portlet-body hide2' style='display:none;'>";
